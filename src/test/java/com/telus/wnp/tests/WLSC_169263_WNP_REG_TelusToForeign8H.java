...
public class WLSC_169263_WNP_REG_TelusToForeign8H extends BaseTest {
	...
	public void BeforeMethod(ITestContext iTestContext) {
		...
		imei = tnTestData.getString("TELUS_SUB_IMEI");
	}

	@Test(groups = { "WLSC_169263_WNP_REG_TelusToForeign8H", "Port-Out", "CompleteRegressionSuite" })
	public void testMethod_TelusToForeign8H(ITestContext iTestContext) throws Exception {
		...
		String incorrectImei = smgTestData.getString("INCORRECT_IMEI");
		SMGICPPortDetailsPageSteps.saveCreatePortRequestDetailsWithIncorrectIMEI(smgTestData, sub, incorrectImei,
				"portout");
		WebDriverSteps.closeTheBrowser();
		Reporting.printAndClearLogGroupStatements();
		...
		String expectedCode = "8H";
		PACDashboardPageSteps.verifyResponseCodeFromPAC(expectedCode);
		WebDriverSteps.closeTheBrowser();
		Reporting.printAndClearLogGroupStatements();

		/*** STEPS FOR VERIFYING 8H DELAY CODE FROM SMG ***/
		Reporting.setNewGroupName("SMG - REJECTION CODE 8H VALIDATION");
		...
		SMGICPPortDetailsPageSteps.performSUP3FromSMGICPPortDetailsPage(smgTestData, "imei", imei);
		WebDriverSteps.closeTheBrowser();
		Reporting.printAndClearLogGroupStatements();
