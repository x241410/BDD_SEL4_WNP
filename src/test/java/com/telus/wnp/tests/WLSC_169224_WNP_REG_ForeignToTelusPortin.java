...
public class WLSC_169224_WNP_REG_ForeignToTelusPortin extends BaseTest {
	...
	@Test(groups = { "WLSC_169224_ForeignToTelusPortin", "Port-In", "CompleteRegressionSuite", "WNP_1st_demo",
			"WNP_FirstDemo" , "Batch1"})
