...
/**
 ****************************************************************************
 * > DESCRIPTION: Receive Cancellation from External Service Provider _confirm
 * flow _FutureDate test > AUTHOR: x241410 > Test Case: TC08_WNP_REG_Receive
 * Cancellation from External Service Provider _confirm flow _FutureDate
 ****************************************************************************
 */

public class WLSC_169272_WNP_REG_ReceiveCancelESPFDate extends BaseTest {
	...
	@Test(groups = { "WLSC_169272_ReceiveCancellationFromESPFutureDate", "ReceiveCancelation",
			"CompleteRegressionSuite" })
	public void testMethod_ReceiveCancellationFromESPFutureDate(ITestContext iTestContext) throws Exception {
		...
		SMGICPPortDetailsPageSteps.saveCreateCancelSVCRequest(smgTestData, sub, ban);
		smgRequestNumber = SMGICPPortDetailsPageSteps.getSMGReqNumber();
		System.out.println("From Test Class-------------> SMG Request Number : " + smgRequestNumber);
		WebDriverSteps.closeTheBrowser();
		Reporting.printAndClearLogGroupStatements();
		...
		/**
		 * Execute below steps on future date
		 */
