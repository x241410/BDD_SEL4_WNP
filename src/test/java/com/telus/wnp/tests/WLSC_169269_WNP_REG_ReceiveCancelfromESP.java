...
/**
 ****************************************************************************
 * > DESCRIPTION: Receive Cancellation from External Service Provider test >
 * AUTHOR: x241410 > Test Case: TC05_WNP_REG_Receive Cancellation from External
 * Service Provider _confirm flow _DDT
 ****************************************************************************
 */

public class WLSC_169269_WNP_REG_ReceiveCancelfromESP extends BaseTest {
	...
	@Test(groups = { "WLSC_169269_ReceiveCancellationfromESP", "ReceiveCancelation", "CompleteRegressionSuite", "Batch1" })
	public void testMethod_ReceiveCancellationfromESP(ITestContext iTestContext) throws Exception {
