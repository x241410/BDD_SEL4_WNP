...
/**
 ****************************************************************************
 * > DESCRIPTION: Telus to RK Port interbrand port in > AUTHOR: x241410 > Test
 * Case: TC12_WNP_REG_Telus to RK Port
 ****************************************************************************
 */

public class WLSC_169276_WNP_REG_TelusPostpaidToRK extends BaseTest {
	...
	@Test(groups = { "WLSC_169276_TelusPostpaidToRK", "TELUS-Interbrand", "CompleteRegressionSuite" })
	public void testMethod_TelusPostpaidToRK(ITestContext iTestContext) throws Exception {
