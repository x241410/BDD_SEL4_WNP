...
/**
 ****************************************************************************
 * > DESCRIPTION: Telus to Koodo interbrand port in > AUTHOR: x241410 > Test
 * Case: TC10_WNP_REG_Telus to koodo Interbrand
 ****************************************************************************
 */

public class WLSC_169274_WNP_REG_TelusToKoodoInterbrand extends BaseTest {
	...
	public void BeforeMethod(ITestContext iTestContext) {
		...
		ban = tnTestData.getString("BAN");

	}

	@Test(groups = { "WLSC_169274_TelusToKoodoInterbrand", "TELUS-Interbrand", "CompleteRegressionSuite" })
	public void testMethod_TelusToKoodoInterbrand(ITestContext iTestContext) throws Exception {
		...
		/*
		 * SmartDesktopSearchPageSteps.verifySubscriberStatusFromSD(sdTestData,
		 * koodoPrepaidNum, ban, "active");
		 * SmartDesktopDashboardPageSteps.navigateToCommunicationHistoryTabToVerifySMS(
		 * sdTestData, sub);
		 */
