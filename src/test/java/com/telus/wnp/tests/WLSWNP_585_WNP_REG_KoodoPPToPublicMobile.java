 ...
 ****************************************************************************
 */
public class WLSWNP_585_WNP_REG_KoodoPPToPublicMobile extends BaseTest {
	...
	@Test(groups = { "WLSWNP_585_WNP_REG_KoodoPPToPublicMobile", "TELUS-Interbrand", "CompleteRegressionSuite" })
	public void testMethod_KoodoPPToPublicMobile(ITestContext iTestContext) throws Exception {
		...
		Reporting.setNewGroupName("SMART DESKTOP - SUB PRE VALIDATION AND ENABLE PP");
		SmartDesktopSearchPageSteps.verifySubscriberStatusFromSD(sdTestData, sub, ban, "active");
		String param = "transfer blocked";
		String comments = "Test User";
		SmartDesktopDashboardPageSteps.performPPFromSD(param, comments);
		WebDriverSteps.closeTheBrowser();
		Reporting.printAndClearLogGroupStatements();
...
/*		SmartDesktopSearchPageSteps.verifySubscriberStatusFromSD(sdTestData, sub, ban, "active");
		...
		Reporting.setNewGroupName("2FA SMS RESPONSE");
		Reporting.logReporter(Status.INFO, "STEP===Responding YES/NO to 2FA SMS===");
