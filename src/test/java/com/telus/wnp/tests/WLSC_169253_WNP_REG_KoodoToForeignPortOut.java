...
public class WLSC_169253_WNP_REG_KoodoToForeignPortOut extends BaseTest {
	...
	@Test(groups = { "WLSC_169253_KoodoToForeignPortOut", "Port-Out", "CompleteRegressionSuite" })
	public void testMethod_KoodoToForeignPortOut(ITestContext iTestContext) throws Exception {
