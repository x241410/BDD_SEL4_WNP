...
public class WLSC_169222_WNP_REG_PortinCancelCloneConfirm extends BaseTest {
	...
	@Test(groups = { "WLSC_169222_WNP_REG_PortinCancelCloneConfirm", "Port-In", "CompleteRegressionSuite", "Batch1" })
	...
	public void testMethod_PortinCancelCloneConfirm(ITestContext iTestContext) throws Exception {
		 ...
		 * 
		 * PACSearchPageSteps.searchPhoneNo(foreignSub); String cancelledStatus =
		 * pacTestData.getString("PORT_STATUS_INTERMEDIATE_2"); String clonedStatus =
		 * pacTestData.getString("PORT_STATUS_BEFORE");
		 * PACSearchPageSteps.verifyCancelAndClonedRequestStatus(cancelledStatus,
		 * clonedStatus);
		 */
		WebDriverSteps.closeTheBrowser();
		Reporting.printAndClearLogGroupStatements();
