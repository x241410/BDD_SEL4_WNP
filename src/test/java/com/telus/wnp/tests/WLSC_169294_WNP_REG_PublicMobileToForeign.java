...
/**
 ****************************************************************************
 * > DESCRIPTION: Port Out_Public Mobile To Foreign Portout > AUTHOR: x241410 >
 * Test Case: TC05_WNP_REG_Public Mobile to Foreign Portout _Delay Wait _Confirm
 ****************************************************************************
 */

public class WLSC_169294_WNP_REG_PublicMobileToForeign extends BaseTest {
	...
	@Test(groups = { "WLSC_169294_WNP_REG_PublicMobileToForeign", "Port-Out", "CompleteRegressionSuite" })
	public void testMethod_PublicMobileToToForeignPortout(ITestContext iTestContext) throws Exception {
		 ...
		 * 
		 * 
			publicMobileNum = "4161766888"; 
			publicMobileBan = "10000001922004";
		 */
