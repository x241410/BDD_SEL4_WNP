...
/**
 ****************************************************************************
 * > DESCRIPTION: Port Out_Confirm and Cancel from SOA > AUTHOR: x241410 > Test
 * Case: TC08_WNP_REG_Port Out_Confirm and Cancel from SOA on behalf of NSP
 ****************************************************************************
 */

public class WLSC_169258_WNP_REG_ConfirmCancelFromSOA extends BaseTest {
	...
	@Test(groups = { "WLSC_169258_PortoutConfirmCancelFromSOA", "Port-Out", "CompleteRegressionSuite", "Batch1" })
	public void testMethod_PortoutConfirmCancelFromSOA(ITestContext iTestContext) throws Exception {
		...
		SMGSOASelectionPageSteps.queryFromSOASelectionPage("fromtn", sub);
		SMGSOASelectionPageSteps.performCancelFromSOAAsNSP(soaTestData);
		WebDriverSteps.closeTheBrowser();
		Reporting.printAndClearLogGroupStatements();
