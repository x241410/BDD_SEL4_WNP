...
public class WLSC_169254_WNP_REG_TelusToForeignPortout extends BaseTest {
	...
	@Test(groups = { "WLSC_169254_TelusToForeignPortout", "Port-Out", "CompleteRegressionSuite" })
	public void testMethod_TelusToForeignPortout(ITestContext iTestContext) throws Exception {
