...
/**
 ****************************************************************************
 * > DESCRIPTION: Foreign to Koodo Prepaid- Modify then Confirm from SMG >
 * AUTHOR: x241410 > Test Case: TC02_WNP_REG_Foreign to Koodo Prepaid _Delay _RR
 * _Modify from SMG _Confirm Flow
 ****************************************************************************
 */
public class WLSC_169288_WNP_REG_ForeignToKPREICPTimer extends BaseTest {
	...
	@Test(groups = { "WLSC_169288_WNP_REG_ForeignToKPREICPTimer", "Port-In", "CompleteRegressionSuite" })
	public void testMethod_ForeignToKPREModifConfirm(ITestContext iTestContext) throws Exception {
		...
		Reporting.setNewGroupName("FOREIGN TO KOODO PREPAID");
		...
		/*
		 * koodoPrepaidNum = "6471150559"; koodoPrepaidBan = "10000002363633";
		 */
		...
		SMGICPPortSelectionPageSteps.createPortOutResponseWithDelayFromSMG(smgTestData, koodoPrepaidNum, sub);
		WebDriverSteps.closeTheBrowser();
		Reporting.printAndClearLogGroupStatements();

		/*** STEPS FOR PORT STATUS VALIDATION FROM PAC ***/
		Reporting.setNewGroupName("PAC INTERMEDIATE VALIDATION - PORT STATUS AND SUMMARY VALIDATION");
		PACDashboardPageSteps.VerifyPortSummaryAndPortStatus(pacTestData, koodoPrepaidNum, "intermediate2");
		WebDriverSteps.closeTheBrowser();
		Reporting.printAndClearLogGroupStatements();
		...
		SMGICPPortSelectionPageSteps.createPortOut8HResponseWithRRFromSMG(smgTestData, koodoPrepaidNum, sub);
		WebDriverSteps.closeTheBrowser();
		Reporting.printAndClearLogGroupStatements();

		/*** STEPS FOR MODIFYING DDDT FROM PAC ***/
		Reporting.setNewGroupName("PAC - MODIFY DDT");
		PACDashboardPageSteps.VerifyPortSummaryAndPortStatus(pacTestData, koodoPrepaidNum, "intermediate3");
		...
		Reporting.setNewGroupName("SMG - CREATE PORT OUT RESPONSE");
		SMGICPPortSelectionPageSteps.createPortOutResponseWithConfirmFromSMG_IMEI(smgTestData, koodoPrepaidNum, sub);
		WebDriverSteps.closeTheBrowser();
		Reporting.printAndClearLogGroupStatements();

		/*** STEPS FOR PORT STATUS VALIDATION FROM PAC ***/
		Reporting.setNewGroupName("PAC INTERMEDIATE VALIDATION - PORT STATUS AND SUMMARY VALIDATION");
		PACDashboardPageSteps.VerifyPortSummaryAndPortStatus(pacTestData, koodoPrepaidNum, "intermediate4");
		WebDriverSteps.closeTheBrowser();
		Reporting.printAndClearLogGroupStatements();
