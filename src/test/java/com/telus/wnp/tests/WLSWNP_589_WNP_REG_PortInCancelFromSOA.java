...
public class WLSWNP_589_WNP_REG_PortInCancelFromSOA extends BaseTest {
	...
	@Test(groups = { "WLSWNP_589_WNP_REG_PortInCancelFromSOA", "Port-In", "CompleteRegressionSuite" })
	public void testMethod_PortInCancelFromSOA(ITestContext iTestContext) throws Exception {
