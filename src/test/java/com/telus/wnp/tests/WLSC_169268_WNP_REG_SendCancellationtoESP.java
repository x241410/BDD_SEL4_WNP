...
/**
 ****************************************************************************
 * > DESCRIPTION: Send Cancellation to External Service Provider test > AUTHOR:
 * x241410 > Test Case: TC04_WNP_REG_Send Cancellation to External Service
 * Provider _confirm flow _DDT
 ****************************************************************************
 */

public class WLSC_169268_WNP_REG_SendCancellationtoESP extends BaseTest {
	...
	@Test(groups = { "WLSC_169268_SendCancellationtoESP", "SendCancelation", "CompleteRegressionSuite", "Batch90" })
	public void testMethod_SendCancellationtoESP(ITestContext iTestContext) throws Exception {
