...
public class WLSC_169249_WNP_REG_PortInFalloutCancel extends BaseTest {
	...
	@Test(groups = { "WLSC_169249_WNP_REG_PortInFalloutCancel", "Port-In", "CompleteRegressionSuite", "Batch1" })
	public void testMethod_PortInFalloutCancel(ITestContext iTestContext) throws Exception {
		...
		Reporting.setNewGroupName("SMG - CANCEL REQUEST");
