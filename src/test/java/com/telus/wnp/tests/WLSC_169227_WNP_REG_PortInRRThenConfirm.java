...
public class WLSC_169227_WNP_REG_PortInRRThenConfirm extends BaseTest {
	...
	@Test(groups = { "WLSC_169227_WNP_REG_PortInRRThenConfirm", "Port-In", "CompleteRegressionSuite" , "Batch1"})
