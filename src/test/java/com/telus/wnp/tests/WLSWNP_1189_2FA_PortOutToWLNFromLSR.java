...
/**
 ****************************************************************************
 * > DESCRIPTION: Telus to WLN Verify 2FA sent_Confirm response from LSR >
 * AUTHOR: x241410 > Test Case: "TC04_WNP_REG_Submit Port Out Request from Telus
 * to WLN 8084_Verify 2FA sent_Confirm response"
 ****************************************************************************
 */

public class WLSWNP_1189_2FA_PortOutToWLNFromLSR extends BaseTest {
	...
	@Test(groups = { "WLSWNP_1189_2FA_PortOutToWLNFromLSR", "Port-Out", "WireLine", "CompleteRegressionSuite" })
	public void testMethod_PortOutToWLNFromLSR(ITestContext iTestContext) throws Exception {
		...
		SmartDesktopDashboardPageSteps.openPreviewAndVerifySMSDetails(sdTestData.getString("EXPECTED_BODY_TEXT"), sub);
		WebDriverSteps.closeTheBrowser();
		Reporting.printAndClearLogGroupStatements();
		...
		/*** STEPS FOR WAITING FOR REQUIRED STATUS TO BE DISPLAYED IN LSR ***/
		Reporting.setNewGroupName("LSR PORTAL - WAIT FOR REQUIRED STATUS");
		LSRPageSteps.waitUntilSpecificStatusFromLSR("Confirmed", sub, ban, spid, serviceProvider, ponNumber, 1800);
		WebDriverSteps.closeTheBrowser();
		Reporting.printAndClearLogGroupStatements();
