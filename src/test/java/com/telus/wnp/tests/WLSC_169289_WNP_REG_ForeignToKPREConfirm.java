 ...
 ****************************************************************************
 */
public class WLSC_169289_WNP_REG_ForeignToKPREConfirm extends BaseTest {
	...
	@Test(groups = { "WLSC_169289_WNP_REG_ForeignToKPREModifConfirm", "Port-In", "CompleteRegressionSuite" })
	public void testMethod_ForeignToKPREModifConfirm(ITestContext iTestContext) throws Exception {
		...
		// koodoPrepaidNum = "6471220802";
		// koodoPrepaidBan = "10000002363632";
		...
		/*** STEPS FOR PORT STATUS VALIDATION FROM SMG ***/
		...
		// Resolution Required Response En
		// Fail-Wait
		...
		Reporting.setNewGroupName("SMG - CREATE PORT OUT RESPONSE");
		SMGICPPortSelectionPageSteps.modifyRequestFromSMG(smgTestData, koodoPrepaidNum, sub);
		WebDriverSteps.closeTheBrowser();
		Reporting.printAndClearLogGroupStatements();
