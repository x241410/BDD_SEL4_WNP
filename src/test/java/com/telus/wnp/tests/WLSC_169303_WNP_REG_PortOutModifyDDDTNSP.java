...
public class WLSC_169303_WNP_REG_PortOutModifyDDDTNSP extends BaseTest {
	...
	@Test(groups = { "WLSC_169303_WNP_REG_PortOutModifyDDDTNSP", "Port-Out", "CompleteRegressionSuite" })
	public void testMethod_PortOutModifyDDDTNSP(ITestContext iTestContext) throws Exception {
...
/*		SmartDesktopSearchPageSteps.verifySubscriberStatusFromSD(sdTestData, sub, ban, "active");
		...
		SMGICPPortSelectionPageSteps.performSUP2FromSMG(smgTestData, sub, dddtDate);
		smgRequestNum = SMGICPPortDetailsPageSteps.SMGRequestNumber;
		WebDriverSteps.closeTheBrowser();
		Reporting.printAndClearLogGroupStatements();
