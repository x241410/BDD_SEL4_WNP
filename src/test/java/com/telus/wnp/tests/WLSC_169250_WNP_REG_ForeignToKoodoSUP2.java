...
/**
 ****************************************************************************
 * > DESCRIPTION: Foreign to Koodo Port in with IMEI Fallout > AUTHOR: x241410 >
 * Test Case: TC20_WNP_REG_WLS Port In_SUP_Foreign to Koodo Port in with IMEI
 * Fallout _Modify DDT from PAC _SUP2
 ****************************************************************************
 */

public class WLSC_169250_WNP_REG_ForeignToKoodoSUP2 extends BaseTest {
	...
	@Test(groups = { "WLSC_169250_ForeignToKoodoIMEIFallOut", "Port-In", "CompleteRegressionSuite", "Batch1" })
	public void testMethod_ForeignToTelusPortin(ITestContext iTestContext) throws Exception {
		...
		int delayInMinutes = pacTestData.getInt("DDDT_DELAY_IN_MINUTES");
