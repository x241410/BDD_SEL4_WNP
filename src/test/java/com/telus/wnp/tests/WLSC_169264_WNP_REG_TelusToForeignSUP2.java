...
/**
 ****************************************************************************
 * > DESCRIPTION: Port Out_Telus To Foreign Portout > AUTHOR: x241410 > Test
 * Case: TC04_WNP_REG_Port Out_Telus to Foreign Portout _confirm flow
 ****************************************************************************
 */

public class WLSC_169264_WNP_REG_TelusToForeignSUP2 extends BaseTest {
	...
	@Test(groups = { "WLSC_169264_WNP_REG_TelusToForeignSUP2", "Port-Out", "CompleteRegressionSuite" })
	public void testMethod_TelusToForeignSUP2(ITestContext iTestContext) throws Exception {
		...
		/*** STEPS FOR SUP2 FROM SMG ***/
		Reporting.setNewGroupName("SMG - SUP2");
