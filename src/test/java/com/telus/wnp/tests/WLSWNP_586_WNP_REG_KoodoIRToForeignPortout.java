...
/**
 ****************************************************************************
 * > DESCRIPTION: Koodo Postpaid (IR) To Foreign Portout > AUTHOR: x241410 >
 * Test Case: TC09_WNP_REG_2FA_Initiate Port request from Koodo Postpaid (IR) To
 * Foreign_Inter carrier_Customer sends \"Yes\"_Verify that request should be
 * completed
 ****************************************************************************
 */

public class WLSWNP_586_WNP_REG_KoodoIRToForeignPortout extends BaseTest {
	...
	@Test(groups = { "WLSWNP_586_WNP_REG_KoodoIRToForeignPortout", "Port-Out", "CompleteRegressionSuite" })
	public void testMethod_KoodoIRToForeignPortout(ITestContext iTestContext) throws Exception {
