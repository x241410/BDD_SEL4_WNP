...
/**
 ****************************************************************************
 * > DESCRIPTION: SOA_Foreign to Telus Port in _perform Modify pending > AUTHOR:
 * x241410 > Test Case: TC16_WNP_REG_WLS Port In_SOA_Foreign to Telus Port in
 * _perform Modify pending from SMG SOA
 ****************************************************************************
 */

public class WLSC_169245_WNP_REG_ModifyPendingFromSOA extends BaseTest {
	...
	@Test(groups = { "WLSC_169245_WNP_REG_ModifyPendingFromSOA", "Port-In", "CompleteRegressionSuite" })
	public void testMethod_ModifyPendingFromSOA(ITestContext iTestContext) throws Exception {
		...
		/*** STEPS TO PERFORM MODIFY PENDING FROM SMG SOA ***/
		Reporting.setNewGroupName("SOA - MODIFY PENDING");
		...
		String ddt_dateTime = GenericUtils.getDDDTWithDelay(30);
		SMGSOASelectionPageSteps.performModifyPending(soaTestData, foreignSub, ddt_dateTime);
		WebDriverSteps.closeTheBrowser();
		Reporting.printAndClearLogGroupStatements();
