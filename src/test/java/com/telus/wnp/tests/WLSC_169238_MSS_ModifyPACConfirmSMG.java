...
public class WLSC_169238_MSS_ModifyPACConfirmSMG extends BaseTest {
	...
	@Test(groups = { "WLSC_169238_MSS_ModifyPACConfirmSMG", "MSS", "CompleteRegressionSuite" })
	public void testMethod_ModifyPACConfirmSMG(ITestContext iTestContext) throws Exception {
		...
		/*
		 * foreignSub = "6471225444"; foreignBan = "70934756";
		 */
		...
		String ddt = GenericUtils.getDDDTWithDelayInPACFormatForJenkinsNodes(smgTestData.getInt("NEW_DDDT_DELAY"));
		PACDashboardPageSteps.modifyAccountRequestFromPAC(pacTestData, foreignSub, "988889555", ddt);
		WebDriverSteps.closeTheBrowser();
		Reporting.printAndClearLogGroupStatements();
