...
/**
 ****************************************************************************
 * > DESCRIPTION: Foreign to Telus Port Telus (Corp Account) in with confirm
 * flow > AUTHOR: x241410 > Test Case: TC11_WNP_REG_2FA_Foreign to Telus Port
 * Telus (Corp Account) in with confirm flow then modify the request after NPAC
 * processing started-
 ****************************************************************************
 */

public class WLSWNP_588_WNP_REG_ForeignToTelusCorp extends BaseTest {
	...
	@Test(groups = { "WLSWNP_588_WNP_REG_ForeignToTelusCorp", "Port-In", "CompleteRegressionSuite", "Batch1"})
	public void testMethod_ForeignToTelusCorp(ITestContext iTestContext) throws Exception {
