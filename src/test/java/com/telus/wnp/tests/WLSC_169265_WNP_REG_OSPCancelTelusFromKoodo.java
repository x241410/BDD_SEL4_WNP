...
/**
 ****************************************************************************
 * > DESCRIPTION: OSP Cancel_OSP Cancel Request Telus From Koodo > AUTHOR:
 * x241410 > Test Case: TC01_WNP_REG_OSP Cancel Request _Telus _From Koodo
 ****************************************************************************
 */

public class WLSC_169265_WNP_REG_OSPCancelTelusFromKoodo extends BaseTest {
	...
	@Test(groups = { "WLSC_169265_OSPCancelRequestTelusFromKoodo", "OSP Cancel", "CompleteRegressionSuite", "Batch1" })
	public void testMethod_OSPCancelRequestTelusFromKoodo(ITestContext iTestContext) throws Exception {
		...
		SmartDesktopDashboardPageSteps.submitOSPCancelReqFromSubscriberTab(sdTestData, koodoSub, koodoBan, sub, ban);
		WebDriverSteps.closeTheBrowser();
		Reporting.printAndClearLogGroupStatements();
		...
		SmartDesktopSearchPageSteps.verifySubscriberStatusFromSD(sdTestData, koodoSub, koodoBan, "active");
