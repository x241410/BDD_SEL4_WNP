...
public class MSSPartnersPageSteps extends BaseSteps {
	...
	public static void performActivationFromMSS(JSONObject testDataJson, String subscriberType) {
		...
		try {
			...
			BaseSteps.Waits.waitForElementToBeClickable(MSSPartnersPage.accountTypeConsumerRegular);
			BaseSteps.Clicks.clickElement(MSSPartnersPage.accountTypeConsumerRegular);
			...
			if (stat) {
				...
				BaseSteps.Dropdowns.selectByVisibleText(MSSPartnersPage.selectAreaCodeWithThreeDigits, "(416) 140");
			...
			BaseSteps.SendKeys.sendKey(MSSPartnersPage.enterValidSIMNumber,
					testDataJson.getString("VALID_TELUS_SIM_NUMBER"));
			BaseSteps.Waits.waitGeneric(2000);
			BaseSteps.Clicks.clickElement(MSSPartnersPage.deviceTypeDropDownOfferType);
			BaseSteps.Waits.waitGeneric(5000);
			BaseSteps.Clicks.clickElement(MSSPartnersPage.deviceTypeDropDownOfferType);
			// BaseSteps.Waits.waitForElementToBeClickableLongWait(MSSPartnersPage.deviceTypeDropDownOfferType);
			// BaseSteps.Debugs.scrollToElement(MSSPartnersPage.deviceTypeDropDownOfferType);

			BaseSteps.Dropdowns.selectByVisibleText(MSSPartnersPage.deviceTypeDropDownOfferType,
			...
			// BaseSteps.Waits.waitForElementVisibility(MSSPartnersPage.MSSAutomationConsumerOffer,
			// 60);
	...
	public static void enterCustomerInformation(JSONObject testDataJson, MSSPartnersPage MSSPartnersPage) {
	...
	public static void enterExternalPortinNumberDetails(JSONObject testDataJson, MSSPartnersPage MSSPartnersPage) {
	...
	public static void enterSINNumber(MSSPartnersPage MSSPartnersPage, String SINNum) {
	...
	public static void handleCreateNewAccountPopup(MSSPartnersPage MSSPartnersPage) {
	...
	public static void selectRequiredOffer(JSONObject testDataJson, MSSPartnersPage MSSPartnersPage) {
		try {
	...
	public static void declinePerkOfferIdIfDisplayed(MSSPartnersPage MSSPartnersPage) {
		try {
	...
	public static void selectDefaultPromotions(JSONObject testDataJson, MSSPartnersPage MSSPartnersPage) {
		try {
	...
	public static void selectNewRatePlan(JSONObject testDataJson, MSSPartnersPage MSSPartnersPage) {
		try {
			BaseSteps.Waits.waitForElementVisibility(MSSPartnersPage.newRatePlanDropDown, 60);
	...
	public static void handleEasyRoamCheckBox(MSSPartnersPage MSSPartnersPage) {
		try {
	...
	public static void checkIfWarningPopupForSelectedOfferDisplayed(MSSPartnersPage MSSPartnersPage) {
	...
	public static void navigateToModifyExistingAccountPage(MSSPartnersPage MSSPartnersPage) {
	...
	public static void provideIdentificationDetails(MSSPartnersPage MSSPartnersPage, String param, String value) {
	...
	public static void selectRequiredOffer_NEW(JSONObject testDataJson, MSSPartnersPage MSSPartnersPage) {
		try {
	...
	public static void initiateMigartionDetailsSubmission(JSONObject testDataJson, MSSPartnersPage MSSPartnersPage) {
	...
	public static void selectSpecificPromotionByName(JSONObject testDataJson, MSSPartnersPage MSSPartnersPage) {
		try {
			// String programName = testDataJson.getString("PROMOTION_PROGRAM_ID");
	...
	public static void selectDeviceFromOffersPage(String deviceName, MSSPartnersPage MSSPartnersPage) {
		BaseSteps.Waits.waitGeneric(2000);
	...
	public static void selectIMEIFromOffersPage(String imei, MSSPartnersPage MSSPartnersPage) {
	...
	public static void selectSIMNumberFromOffersPage(String sim, MSSPartnersPage MSSPartnersPage) {
	...
	public static void reSelectSIMAndIMEIWithDevice(String deviceName, String sim, String imei,
			MSSPartnersPage MSSPartnersPage) {
